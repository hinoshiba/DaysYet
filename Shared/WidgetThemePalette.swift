...
struct WidgetThemePalette {
    ...
    func colors(for kind: MetricKind) -> [Color] {
        ...
        case .activity: metricGradients[6]
        case .study: metricGradients[7]
        }
    }
        ...
        case .vividNight:
            return WidgetThemePalette(
                ...
                metricGradients: [
                    ...
                    [Color(red: 0.98, green: 0.59, blue: 0.65), Color(red: 0.94, green: 0.43, blue: 0.50)],
                    [Color(red: 0.50, green: 0.68, blue: 1.0), Color(red: 0.65, green: 0.51, blue: 0.98)]
                ]
            )
        case .quietForest:
            return WidgetThemePalette(
                ...
                metricGradients: [
                    ...
                    [Color(red: 0.53, green: 0.38, blue: 0.41), Color(red: 0.48, green: 0.33, blue: 0.38)],
                    [Color(red: 0.33, green: 0.43, blue: 0.53), Color(red: 0.39, green: 0.37, blue: 0.54)]
                ]
            )
        case .softDawn:
            return WidgetThemePalette(
                ...
                metricGradients: [
                    ...
                    [Color(red: 0.64, green: 0.35, blue: 0.43), Color(red: 0.59, green: 0.31, blue: 0.41)],
                    [Color(red: 0.39, green: 0.42, blue: 0.61), Color(red: 0.49, green: 0.36, blue: 0.59)]
                ]
            )
        case .calmSea:
            return WidgetThemePalette(
                ...
                metricGradients: [
                    ...
                    [Color(red: 0.49, green: 0.38, blue: 0.48), Color(red: 0.44, green: 0.35, blue: 0.48)],
                    [Color(red: 0.30, green: 0.44, blue: 0.64), Color(red: 0.41, green: 0.38, blue: 0.62)]
                ]
            )
        }
    }
