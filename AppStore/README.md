...
The four images in each locale/device folder show: (1) progress bars, (2) time left with elapsed percentage and bars, (3) the timeline library, and (4) on-device privacy and OSS information. All sample dates are fictional.
