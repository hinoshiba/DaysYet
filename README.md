...
今週、今月、今年、健康でいたい年齢、大切な日から3つを選び、1つのウィジェットで静かに見渡すiPhone / iPadアプリです。カウントダウン、時間＋割合＋バー、プログレスバーの3レイアウトと、4つのカラーテーマを選べます。

## Features

- アプリで選んだ3本を1つのウィジェットに表示
- ウィジェットごとに3本、表示形式、テーマを上書き可能
- 今週、今月、今年、本人が設定する健康年齢の目標、起算日を指定できる任意の目標日時
- カウントダウン／時間＋割合＋バー／プログレスバーの切り替え
- プログレスバー右側の値を、残り時間・残り割合・終了日時から切り替え
